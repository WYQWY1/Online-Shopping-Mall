    ...
    <div class="nav">
      ...
      <ul class="detail">
        <li class="first" v-show="!userInfo.username">
         <router-link to="/login"> <Icon type="log-in"></Icon> 登录</router-link> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;<span class="text-color-red"><router-link to="/SignUp"> <Icon type="log-in"></Icon> 注册 </router-link></span>
        </li>
        ...
        <li><router-link to="/Feedback"><Icon type="document-text"></Icon>&nbsp;意见反馈</router-link></li>
        <li><router-link to="/"><Icon type="home"></Icon>&nbsp;首页</router-link></li>
      </ul>
    </div>
  </div>
</template>
