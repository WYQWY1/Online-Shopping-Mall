        ...
        <div class="friend-link">
          <div class="friend-link-item">
            <ul>
              ...
              <router-link to="Feedback" target="_blank"  tag="a">
...
export default {
  ...
  data () {
    return {
      ...
      guideArr: [
        [ '新手入门','购物流程', ' 会员介绍', ' 常见问题', '发票说明','联系客服' ],
        [ '付款方式', '货到付款', ' 在线支付'],
        [ '消费者保障','保障范围', ' 退货退款流程', ' 服务中心', '更多特色服务'  ],
        [ '商家支持', '商家入驻', '商家规则', '商家常见问题'],
      ],
      moreLink: [
        '意见反馈', '联系我们', '联系客服', '合作招商', '商家帮助', '营销中心', '销售联盟', '校园社区', '风险监测', '隐私政策'
      ]
    };
  }
};
